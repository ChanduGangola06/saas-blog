...
const Features = () => {
    return (
        <section id='features'
            ...
            {/* <!-- section title --> */}
            <SectionHeader title={"Launch SaaS Startup in Days"} description="Everything you need to build, launch, and scale your SaaS startup." />
            <div className='relative z-1 mx-auto w-full max-w-[1170px] px-4 sm:px-8 xl:px-0'>
                ...
                <div className='hidden sm:block'>
                    <div className='absolute left-0 top-1/2 -z-1 -translate-y-1/2'>
                        <Image src='/images/features/features-shape-01.svg'
                            alt='shape'
                            width={600}
                            height={600}
                        />
